...
\begin{itemize}[label=\textbullet, itemsep=0.3em]
    ...
    \IfFileExists{figures/sap-logo.png}{%
        ...
        \fbox{\parbox[c][1.5cm][c]{4cm}{\centering \small Logo S/4HANA\\(ajoutez figures/sap-logo.png)}}
    }
    \end{center}
    ...
    \IfFileExists{figures/logo-rap-cds.jpg}{%
        ...
        \fbox{\parbox[c][1.5cm][c]{4cm}{\centering \small Logo RAP/CDS\\(ajoutez figures/logo-rap-cds.png)}}
    }
    \end{center}
