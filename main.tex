...
\noindent\hspace*{2em}\hyperref[ch3:rejet-comm]{3.4.4 Module de gestion des exceptions et anomalies} \dotfill \pageref*{ch3:rejet-comm}\\
...
\subsection{Module de gestion des exceptions et anomalies}\label{ch3:rejet-comm}
