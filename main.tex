...
\noindent\hspace*{1em}\hyperref[ch5:implementation]{5.3 Impl\'ementation et d\'emonstration de la solution} \dotfill \pageref*{ch5:implementation}\\
\noindent\hspace*{2em}\hyperref[ch5:voir-po]{5.3.1 Visualisation des commandes (Voir les PO)} \dotfill \pageref*{ch5:voir-po}\\
\noindent\hspace*{2em}\hyperref[ch5:confirmer]{5.3.2 Confirmation unitaire des postes (Confirmer)} \dotfill \pageref*{ch5:confirmer}\\
\noindent\hspace*{2em}\hyperref[ch5:rejeter]{5.3.3 Rejet des postes avec motif (Rejeter)} \dotfill \pageref*{ch5:rejeter}\\
\noindent\hspace*{2em}\hyperref[ch5:replanifier]{5.3.4 Replanification des dates de livraison (Replanifier)} \dotfill \pageref*{ch5:replanifier}\\
\noindent\hspace*{2em}\hyperref[ch5:masse]{5.3.5 Confirmation en masse via Excel} \dotfill \pageref*{ch5:masse}\\
\noindent\hspace*{2em}\hyperref[ch5:imprimer]{5.3.6 Impression des bons de commande (Imprimer)} \dotfill \pageref*{ch5:imprimer}\\
\noindent\hspace*{2em}\hyperref[ch5:ia]{5.3.7 Automatisation conversationnelle (Agent IA Joule)} \dotfill \pageref*{ch5:ia}\\
\noindent\hspace*{2em}\hyperref[ch5:dashboard]{5.3.8 Pilotage analytique et KPI (Consulter les graphiques)} \dotfill \pageref*{ch5:dashboard}\\
\noindent\hspace*{1em}\hyperref[ch5:tests]{5.4 Tests et validation} \dotfill \pageref*{ch5:tests}\\
...
\section{Impl\'ementation et d\'emonstration de la solution}\label{ch5:implementation}
