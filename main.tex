...
\IfFileExists{figures/sequence-diagram.png}{%
    ...
    \fbox{\parbox[c][5cm][c]{0.9\linewidth}{\centering \small Diagramme de séquence\\(ajoutez figures/sequence-diagram.png)}}
}
\caption{Diagramme de séquence de la confirmation en masse via fichier Excel}
\label{fig:sequence}
\end{figure}
